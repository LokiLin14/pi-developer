...
2. Ask a small batch of high-value questions, then wait for answers. For material revisions, restate the requested delta and settle remaining consequential choices with a recommendation before rewriting; do not reopen settled choices or require approval merely to draft. Edit trivial corrections directly. Challenge the problem before the solution: who needs this, what fails today, what observable result counts as success, and what is the smallest sufficient change?
